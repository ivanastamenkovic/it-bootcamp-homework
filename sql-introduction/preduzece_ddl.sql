...
(
    ...
    ime_odeljenja  varchar(25)         NOT NULL,
    mesto          varchar(20)
);
...
insert into public.radnik values (5367, 'Petar', 'vozac', 'KV', 5780, '1978-01-01', 1900, 1300, 20);
...
insert into public.radnik values (5898, 'Andro', 'nabavljac', 'KV', 5786, '1980-01-20', 1200, 1100, 30);
insert into public.radnik values (5900, 'Slobo', 'vozac', 'KV', 5780, '1978-10-03', 1300, 900, 20);
insert into public.radnik values (5932, 'Mita', 'savetnik', 'VSS', 5842, '1965-03-25', NULL, 2600, 20);
insert into public.radnik values (5953, 'Pero', 'nabavljac', 'KV', 5786, '1979-01-12', 0, 1100, 30);
insert into public.radnik values (6234, 'Marko', 'analiticar', 'VSS', 5786, '1990-12-17', 3000, 1300, 10);
insert into public.radnik values (6789, 'Janko', 'rukovodilac', 'VSS', NULL, '1999-12-23', 10, 3900, 40);
insert into public.radnik values (7890, 'Ivan', 'analiticar', 'VSS', 5786, '1990-12-17', 3200, 1600, 20);

insert into public.ucesce values (5497, 400, 2000, 'IZVRSILAC');
insert into public.ucesce values (5519, 300, 2000, 'IZVRSILAC');
insert into public.ucesce values (5652, 100, 1000, 'IZVRSILAC');
insert into public.ucesce values (5652, 300, 1000, 'IZVRSILAC');
insert into public.ucesce values (5662, 300, 2000, 'SEF');
insert into public.ucesce values (5696, 200, 2000, 'SEF');
insert into public.ucesce values (5696, 300, 2000, 'IZVRSILAC');
insert into public.ucesce values (5780, 200, 2000, 'ORGANIZATOR');
insert into public.ucesce values (5786, 100, 2000, 'KONSULTANT');
insert into public.ucesce values (5842, 100, 2000, 'SEF');
insert into public.ucesce values (5867, 200, 2000, 'KONSULTANT');
insert into public.ucesce values (5898, 200, 2000, 'IZVRSILAC');
insert into public.ucesce values (5900, 100, 2000, 'IZVRSILAC');
...
insert into public.ucesce values (5953, 100, 1000, 'IZVRSILAC');
insert into public.ucesce values (5953, 300, 1000, 'IZVRSILAC');
insert into public.ucesce values (6234, 100, 500, 'NADZORNIK');
insert into public.ucesce values (6234, 200, 1200, 'IZVRSILAC');
insert into public.ucesce values (6234, 300, 300, 'KONSULTANT');
insert into public.ucesce values (6789, 200, 2000, 'IZVRSILAC');
insert into public.ucesce values (7890, 300, 2000, 'IZVRSILAC');
